...
<html>
    ...
    <body>
        ...
        <?php
            echo "Thank you <u>" . $_POST["name"] . "</u> for participating in this questionnaire";
            ...
            if ($_POST["own"] == "yes")
            {
                ...
                if ($_POST["rating"] == "yes")
                    ...
                    echo "<br> We're sorry that you did not enjoy your stay in the land of Hyrule.";
            }
            else 
                echo "!";
            ...
            echo "<br><br> Your score: " . $num_correct . "/3";
        ?>
    </body>
</html>